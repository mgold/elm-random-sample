...
Elm.Main.make = function (_elm) {
            ...
            return function () {
                 ...
                 {case "_Tuple2":
                    return F2(function (x,y) {
                         return x + y;
                      })(_v1._0)((val - _v0._0) / (_v0._1 - _v0._0) * (_v1._1 - _v1._0));}
                 _U.badCase($moduleName,
                 "on line 51, column 32 to 74");
              }();}
         _U.badCase($moduleName,
         "on line 51, column 32 to 74");
      }();
   });
   var grid_viz = function (g) {
      return function () {
         var max = $Basics.toFloat($List.maximum($Dict.values(g)));
         var min = $Basics.toFloat($List.minimum($Dict.values(g)));
         var normalize = A2(linear,
         {ctor: "_Tuple2"
         ,_0: min
         ,_1: max},
         ...
         var colors = function ($) {
            return A2(color,
            $Color.darkCharcoal,
            $Color.lightGrey)(normalize($Basics.toFloat($)));
         };
         var forms = $List.concatMap(function (_v8) {
            return function () {
               switch (_v8.ctor)
               {case "_Tuple2":
                  switch (_v8._0.ctor)
                    {case "_Tuple2":
                       return _L.fromArray([$Graphics$Collage.move({ctor: "_Tuple2"
                                                                   ,_0: 50 * $Basics.toFloat(_v8._0._0)
                                                                   ,_1: 50 * $Basics.toFloat(_v8._0._1)})($Graphics$Collage.filled(colors(_v8._1))($Graphics$Collage.circle(10)))
                                           ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                                   ,_0: 50 * $Basics.toFloat(_v8._0._0)
                                                                   ,_1: -18 + 50 * $Basics.toFloat(_v8._0._1)})($Graphics$Collage.toForm($Text.asText(_v8._1)))]);}
                    break;}
               _U.badCase($moduleName,
         ...
         _L.fromArray([$Graphics$Collage.move({ctor: "_Tuple2"
                                              ,_0: -250
                                              ,_1: -250})($Graphics$Collage.group(forms))]));
      }();
   };
   var table = function (d) {
      return function () {
         var row = function (_v14) {
            return function () {
               switch (_v14.ctor)
               {case "_Tuple2":
                  return A2($Graphics$Element.flow,
                    $Graphics$Element.right,
                    _L.fromArray([$Text.asText(_v14._1)
                                 ,A2($Graphics$Element.spacer,
                                 20,
                                 20)
                                 ,$Text.asText(_v14._0)]));}
               _U.badCase($moduleName,
               "on line 25, column 27 to 82");
            }();
         };
   ...
   var multiset = function (xs) {
      return function () {
         var incr = function (m_int) {
            return function () {
               switch (m_int.ctor)
               {case "Just":
                  return $Maybe.Just(m_int._0 + 1);
                  case "Nothing":
                  return $Maybe.Just(1);}
               _U.badCase($moduleName,
   ...
   var grid = multiset(A2($List.concatMap,
...
Elm.Random.Array.make = function (_elm) {
   ...
   seed) {
      ...
      $Array.empty) ? {ctor: "_Tuple3"
         ...
         index = $._0,
         seed$ = $._1;
         var arr$ = A2($Array.append,
         A3($Array.slice,0,index,arr),
         A3($Array.slice,
         index + 1,
         $Array.length(arr),
         arr));
               ...
               {case "_Tuple3":
                  return function () {
                       ...
                       return function () {
                          switch (m_val.ctor)
                          {case "Just":
                             return $Trampoline.Continue(function (_v11) {
                                  return function () {
                                     switch (_v11.ctor)
                                     {case "_Tuple0":
